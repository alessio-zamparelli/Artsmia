...
public class ArtsmiaDAO {
	...
	/**
	 * Ritorna la lista di {@code ArtObject} presenti nel db
	 * 
	 * @param idMap la mappa del model
	 * @return la lista di oggetti {@code ArtObject}
	 */
	...
	public List<Adiacenza> listAdiacenze() {
		...
		String sql = "SELECT eo1.object_id AS o1, eo2.object_id AS o2, COUNT(*) AS cnt "
				...
				+ "GROUP BY eo2.object_id, eo2.object_id";
